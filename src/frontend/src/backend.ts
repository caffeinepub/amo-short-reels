...
import type { Notification as _Notification, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async bookmarkReel(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.bookmarkReel(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createVideoReel(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Array<string>, arg5: string, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createVideoReel(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBookmarks(): Promise<Array<VideoReel>> {
        if (this.processError) {
            try {
    ...
    async getFeed(arg0: bigint, arg1: bigint): Promise<Array<VideoReel>> {
        if (this.processError) {
            try {
    ...
    async getFollowingFeed(arg0: bigint, arg1: bigint): Promise<Array<VideoReel>> {
        if (this.processError) {
            try {
    ...
    async getTrendingHashtags(arg0: bigint): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async getTrendingReels(arg0: bigint): Promise<Array<VideoReel>> {
        if (this.processError) {
            try {
    ...
    async getUserVideoReels(arg0: Principal): Promise<Array<VideoReel>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserVideoReels(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchReels(arg0: string): Promise<Array<VideoReel>> {
        if (this.processError) {
            try {
    ...
    async unbookmarkReel(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unbookmarkReel(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
